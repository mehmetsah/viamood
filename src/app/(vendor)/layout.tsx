    ...
    <div className="min-h-screen flex bg-neutral-50">
      <aside className="w-60 bg-white border-r flex flex-col">
        ...
        <nav className="flex-1 p-3 flex flex-col gap-1 text-sm">
          ...
          <Link href="/orders/ai-shipment" className="px-3 py-2 rounded-lg hover:bg-neutral-100 text-sm">
            🤖 AI Kargo
          </Link>
          <Link href="/kargo" className="px-3 py-2 rounded-lg hover:bg-neutral-100">
            📦 Kargo &amp; Cari
          </Link>

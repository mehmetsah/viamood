...
for m in 0008_customers 0009_native_orders 0010_carts 0011_store_settings 0012_settings_backend_theme 0013_returns 0014_reviews 0015_goknil_admin 0016_goknil_pwreset 0017_goknil_upsert 0018_tenants 0019_kargolab_vendor_member 0020_kargolab_enabled; do
